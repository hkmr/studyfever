...
<?php 
	...
	$result_query = "select * from query where ques_query like '%$get_value%'";
	...
	while($row_result=mysql_fetch_array($run_result)){
		...
		$ques_query=$row_result['site_title'];
		$ques_res=$row_result['site_link'];
